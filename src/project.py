# main file that runs the web server and interfaces with the PostgreSQL database
...
# Return parsed results of SQL query
...
# Return specific blocks and tuple ids using ctid 
...
# Return specific tuple information
